...
export default function TopBar({ title, state, onReset, onHelp }: TopBarProps) {
  return (
    <header className="topbar">
      ...
      <div className="topbar-status">
        <div className="status-item"><span>Scenario</span><strong><span className="status-dot" aria-hidden="true" />{state.completed ? 'Complete' : 'In progress'}</strong></div>
